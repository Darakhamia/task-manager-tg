...
• Создавать задачи в твоём Notion
• Показывать список задач
• Менять статус, дедлайн и приоритет задач
• Удалять задачи
...
Теперь просто отправляй мне текстовые или голосовые сообщения — я пойму, что ты хочешь сделать.

<b>Примеры:</b>
• «Купить молоко завтра» — создаст задачу
• «Покажи мои задачи» — покажет список
• «Задачу про молоко поменяй на готово» — обновит статус
• «Удали задачу про молоко» — удалит задачу
• «Перенеси дедлайн задачи про отчёт на пятницу» — обновит дату
